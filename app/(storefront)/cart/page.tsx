          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-4">
              {items.map((item) => (
                <div key={item.id} className="flex gap-4 p-4 bg-obsidian border border-carbon">
                  <div className="w-24 h-24 bg-carbon flex-shrink-0 overflow-hidden">
                    {item.image?.src && (
                      <Image
                        src={item.image.src}
                        alt={item.name}
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-between">
                    <div className="flex justify-between gap-4">
                      ...
                      <button
                        ...
                        className="text-ash hover:text-blood transition-colors flex-shrink-0"
                        aria-label="Eliminar producto"
                      >
                        <X size={16} />
                      </button>
                    </div>
                    {item.sku && <p className="text-xs text-ash">SKU: {item.sku}</p>}
            ...
            <div className="lg:col-span-1">
              <div className="bg-obsidian border border-carbon p-6 sticky top-32">
                ...
                {/* Trust signals */}
                <div className="mt-6 pt-6 border-t border-carbon space-y-2">
