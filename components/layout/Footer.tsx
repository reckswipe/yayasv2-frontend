        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div>
            <Link href="/" className="block mb-4 hover:opacity-80 transition-opacity">
              <Image src="https://compra.yayas.com.mx/wp-content/uploads/2026/05/transparent-Photoroom.png" alt="YAYAS" width={140} height={47} className="h-12 w-auto object-contain" />
            </Link>
