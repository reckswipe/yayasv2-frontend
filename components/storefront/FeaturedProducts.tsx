...
const DEMO_PRODUCTS: Product[] = [
  {
    ...
    price: 850,
    handle: "void-texture-tee",
    image: "https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=600&h=750&fit=crop",
    hoverImage: "https://images.unsplash.com/photo-1618354691438-25bc04584c23?w=600&h=750&fit=crop",
  },
  {
    id: 2,
    name: "OBSIDIAN Hoodie",
    price: 1450,
    handle: "obsidian-hoodie",
    image: "https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=600&h=750&fit=crop",
    hoverImage: "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=600&h=750&fit=crop",
  },
  {
    id: 3,
    name: "CARBON Crossbody",
    price: 680,
    handle: "carbon-crossbody",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-12">
          ...
          <Link
            ...
            className="hidden md:flex items-center gap-2 text-sm uppercase tracking-widest hover:text-gold transition-colors group"
          >
            Ver todo
            <span className="w-0 group-hover:w-4 h-px bg-current transition-all" />
          </Link>
        </div>
        ...
        <div className="mt-10 text-center md:hidden">
          <Link
            href="/collections/all"
            className="px-8 py-3 border border-carbon text-ash font-syne uppercase tracking-widest text-sm hover:border-smoke transition-colors"
          >
            Ver todo
          </Link>
        </div>
